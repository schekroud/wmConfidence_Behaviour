...
if vis: #this plots the distributions that are generated by sampling a von mises with the mean fitted kappa of the task data
    ...
    ax.set_xlabel('simulated response error (°)')
    fig.savefig(op.join(wd, 'supplementary_analysis_figures', 'simulation_analyses', 'SimulateResponseError_ExampleSubjectDistributions.eps'), format = 'eps', dpi = 300)
    fig.savefig(op.join(wd, 'supplementary_analysis_figures', 'simulation_analyses', 'SimulateResponseError_ExampleSubjectDistributions.pdf'), format = 'pdf', dpi = 300)
...
fig = plt.figure()
ax = fig.add_subplot(111)
# ax.hist(tvals, bins = 100, alpha = 0.7, color = '#1c9099')
...
fig.savefig(op.join(wd, 'supplementary_analysis_figures', 'simulation_analyses', 'RandomEffectsControl_tval_NullDistribution.eps'), format = 'eps', dpi = 300)
fig.savefig(op.join(wd, 'supplementary_analysis_figures', 'simulation_analyses', 'RandomEffectsControl_tval_NullDistribution.pdf'), format = 'pdf', dpi = 300)
