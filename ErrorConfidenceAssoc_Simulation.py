...
sys.path.insert(0, 'C:/Users/sammi/Desktop/Experiments/pyCircMixModel')
...
wd = 'C:/Users/sammi/Desktop/Experiments/DPhil/wmConfidence_Behaviour'
os.chdir(wd)
#%%
...
with progressbar.ProgressBar(max_value = nsims) as bar:
    for isim in range(nsims):
        ...
        # res = sp.stats.ttest_rel(df_mad.query('condition == "cued"').absrdif, df_mad.query('condition == "neutral"').absrdif)
